...
test('Thematic breaks (https://github.github.com/gfm/#example-20)', t => {
  const actual = compile('_____________________________________')
  t.is('<hr>', actual)
})
...
test('ATX headings (https://github.github.com/gfm/#example-36)', t => {
  const actual = compile('# foo *bar* \\*baz\\*')
...
//   const actual = compile('<DIV CLASS="foo">\n\n*Markdown*\n\n</DIV>')
//   t.is('<div class="foo">\n<p><em>Markdown</em></p>\n</div>', actual)
// })
...
//   const actual = compile('<div id="foo" class="bar\n  baz">\n</div>')
...
//   const actual = compile('<del>*foo*</del>')
...
//   const actual = compile('<style>p{color:red;}</style>\n*foo*')
...
//   const actual = compile('[foo]: /url "title"\n\n[foo]')
...
//   const actual = compile('[foo]: /url "title" ok')
...
//   const actual = compile('  1.  A paragraph\n    with two lines.')
//   t.is('<ol>\n<li>A paragraph\nwith two lines.</li>\n</ol>', actual)
// })

// test('List items (https://github.github.com/gfm/#example-263)', t => {
//   const actual = compile('> 1. > Blockquote\ncontinued here.')
//   t.is(
//     '<blockquote>\n<ol>\n<li>\n<blockquote>\n<p>Blockquote\ncontinued here.</p>\n</blockquote>\n</li>\n</ol>\n</blockquote>',
//     actual
//   )
...
//   const actual = compile('<http://example.com?find=\\*>')
//   t.is(
...
//   const actual = compile('[foo](/f&ouml;&ouml; "f&ouml;&ouml;")')
...
//   const actual = compile('``` f&ouml;&ouml;\nfoo\n```')
...
//   const actual = compile('    f&ouml;f&ouml;')
...
//   const actual = compile('`<http://foo.bar.`baz>`')
...
//   const actual = compile('foo-__(bar)__')
//   t.is('<p>foo-<strong>(bar)</strong></p>', actual)
// })
...
//   const actual = compile('**foo "*bar*" foo**')
...
//   const actual = compile('_foo __bar__ baz_')
...
//   const actual = compile('*foo **bar *baz* bim** bop*')
...
//   const actual = compile('__foo _bar_ baz__')
...
//   const actual = compile('____foo__ bar__')
...
//   const actual = compile('____foo____')
//   t.is('<p><strong><strong>foo</strong></strong></p>', actual)
// })
...
//   const actual = compile('_____foo_____')
...
//   const actual = compile('__<a href="__">')
...
//   const actual = compile('__a<http://foo.bar/?q=__>')
//   t.is(
...
//   const actual = compile('[link](/my uri)')
...
//   const actual = compile('[link](foo(and(bar)))')
...
//   const actual = compile('[link](/url "title "&quot;")')
...
//   const actual = compile('[link](/url "title "and" title")')
...
//   const actual = compile('[foo <bar attr="](baz)">')
...
//   const actual = compile('[foo<http://example.com/?search=](uri)>')
//   t.is(
...
//   const actual = compile('[link [foo [bar]]][ref]\n\n[ref]: /uri')
//   t.is('<p><a href="/uri">link [foo [bar]]</a></p>', actual)
// })

// test('Links (https://github.github.com/gfm/#example-513)', t => {
//   const actual = compile('[link \\[bar][ref]\n\n[ref]: /uri')
//   t.is('<p><a href="/uri">link [bar</a></p>', actual)
// })
...
//   const actual = compile('[![moon](moon.jpg)][ref]\n\n[ref]: /uri')
//   t.is('<p><a href="/uri"><img src="moon.jpg" alt="moon"></a></p>', actual)
// })

// test('Links (https://github.github.com/gfm/#example-516)', t => {
//   const actual = compile('[foo [bar](/uri)][ref]\n\n[ref]: /uri')
...
//   const actual = compile('[foo][ref[bar]]\n\n[ref[bar]]: /uri')
...
//   const actual = compile('[foo](not a link)\n\n[foo]: /url1')
...
//   const actual = compile('![foo ![bar](/url)](/url2)')
...
//   const actual = compile('![foo](train.jpg)')
...
//   const actual = compile('<irc://foo.bar:2233/baz>')
//   t.is(
...
//   const actual = compile('<foo@bar.example.com>')
//   t.is(
...
//   const actual = compile('<foo+special@Bar.baz-bar0.com>')
//   t.is(
...
//   const actual = compile('www.commonmark.org')
//   t.is(
...
//   const actual = compile('www.google.com/search?q=(business))+ok')
//   t.is(
...
//   const actual = compile('www.commonmark.org/he<lp')
//   t.is(
...
//   const actual = compile("<a href='bar'title=title>"))
...
//   const actual = compile('foo <?php echo $a; ?>')
